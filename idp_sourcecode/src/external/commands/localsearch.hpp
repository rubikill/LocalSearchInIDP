...
typedef TypedInference<LIST(AbstractTheory*, Structure*, std::string*)> LocalSearchInferenceBase;
...
public:
    ...
    InternalArgument execute(const std::vector<InternalArgument>& args) const {
        //AbstractTheory *T, Query *getObj, AbstractTheory *Tnext, Query *getValidMoves, Query *getDeltaObj,
        //const Structure *str, Vocabulary *Vmove
